...
if __name__ == '__main__':
    ...
    # Load csv files
    logger.info("Loading csv files {}, {}, {} and {}", preds_files[0], tracks_files[0], static_tracks_files[0], recording_meta_files[0])
    tracks, static_info, meta_info, preds= read_from_csv(tracks_files[0], static_tracks_files[0], recording_meta_files[0], preds_files[0])
    if tracks is None:
    ...
    visualization_plot = TrackVisualizer(config, tracks, preds, static_info, meta_info)
